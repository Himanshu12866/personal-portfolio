...
const Footer = () => {
  ...
  return (
    <>
      <div
        className={`flex justify-center    w-full  px-6 pt-12  ${!darkMode
      ...
      >
        <div
          style={cardStyle}
          className={`${!darkMode ? "bg-[#f5f5f52d]" : "bg-[#f5f5f533]"
            }   shadow-[2px_4px_30px_rgba(0,0,0,0.1)] w-full  backdrop-blur-[5px] `}
        >
          <div className="w-full flex flex-wrap  justify-between p-12">
            <div className=" w-1/4 flex flex-col ">
              ...
              <h3 className="text-xl  font-medium font-heading pt-8 pb-2">
                Himanshu Kumar Mishra
              </h3>
              <p className="text-xl font-para font-medium pe-8">
                Passionate about building clean and modern UIs
              </p>
            </div>
            <div className="w-1/4 ps-12">
              <h3 className="text-2xl pt-2">Experties</h3>
              <ul className="flex flex-col font-medium p-4 md:p-0 capitalize mt-8 font-heading text-xl ">
            ...
            <div className="w-1/4">
              ...
              <form className="mt-4">
                <label className="text-xl font-heading  font-medium pe-8">Let's connect!</label>
                <input
                  type="email" placeholder="Your Email"
                  className={`bg-transparent py-3 mt-4 outline-none px-4 w-4/5 rounded-[10px] 
...
${darkMode
                  ...
                  `} />
                  <div className=" flex justify-start pt-4 items-center w-4/5">
