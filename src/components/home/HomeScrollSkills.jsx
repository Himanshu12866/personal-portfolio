...
const MarqueeRow = ({ items = [], direction = "left", baseSpeed = 0.08 }) => {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e) => {
            ...
            // more aggressive boost if you scroll harder
            const delta = Math.sign(e.deltaY);
            if (delta !== 0) {
                boost.current = 3 * dirFactor * delta; // scroll "with" or "against" direction
            }
        };
    ...
    useAnimationFrame((t, delta) => {
        ...
        if (boost.current !== 1) {
            ...
            // decay back to normal speed gradually
