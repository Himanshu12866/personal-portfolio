...
const HomeProjects = () => {
  ...
  return (
    ...
    >
      ...
      <div className="xl:w-4/5 3xl:w-3/5 w-full grid gap-8 grid-cols-2  ">
        <div
          className={` flex flex-col gap-5 p-4 px-8 rounded-[20px] backdrop-blur-sm ${
  ...
  shadow-[0px_0.706592px_0.706592px_-0.666667px_rgba(0,0,0,0.08),
        ...
        >
          ...
          <div className="flex flex-col gap-2 items-start">
            <h3 className="text-xl">Description:</h3><p className="text-lg overflow-hidden font-para font-medium">A real-time e-commerce web app like Amazon with product management, cart, checkout, payment, and live inventory updates. </p>
          </div>
          <div className="flex flex-col gap-2 items-start">
            <h3 className="text-xl">My Contributions:</h3><p className="text-lg overflow-hidden font-para font-medium">A real-time e-commerce web app like Amazon with product management, cart, checkout, payment, and live inventory updates. </p>
          </div>
